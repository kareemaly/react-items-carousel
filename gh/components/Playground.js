...
export const ItemsCarouselPlayground = () => {
    ...
    <Wrapper>
      ...
      <div style={wrapperStyle}>
        <ItemsCarousel
          ...
          requestToChangeActive={value => setState(prevState => ({ ...prevState, activeItemIndex: value }))}
          rightChevron={
            <Button shape="circle">
              <Icon type="right" />
            </Button>
          ...
          <Variations>
            {variations.map((variation, index) => (
              <Variation
                ...
                key={index}
                onChange={() => setState({ activeItemIndex: 0, activeVariation: variation })}
              >
                {variation.name}
              </Variation>
            ))}
